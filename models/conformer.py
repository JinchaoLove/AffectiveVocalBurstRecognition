# https://github.com/pytorch/audio/blob/main/torchaudio/models/conformer.py
...
class _ConvolutionModule(nn.Module):
    ...
    def __init__(
        ...
        self.sequential = nn.Sequential(
            ...
            if use_group_norm
            else (nn.SyncBatchNorm(num_channels) if is_initialized() else nn.BatchNorm1d(num_channels)),
            nn.SiLU(),
            nn.Conv1d(
                num_channels,
                input_dim,
